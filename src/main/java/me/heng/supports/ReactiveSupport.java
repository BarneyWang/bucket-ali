...
import  me.heng.supports.ReactiveSupport.*;
import me.heng.supports.ReactiveExecutor.TimeoutException;
import org.apache.commons.lang3.tuple.Pair;
import org.apache.commons.lang3.tuple.Triple;

import static me.heng.supports.Functional.map;
...
public class ReactiveSupport {
    ...
    public static <T> ReactiveExecutor.Ex<T, Boolean> falseExHandler() {
        return (ex, input) -> false;
    }

    public static <T> ReactiveExecutor.Ex<T, Boolean> trueExHandler() {
    ...
    public static <I, O> CompletableFuture<List<Triple<I, O, Throwable>>> watchFx(
            Collection<I> inputs, ReactiveExecutor.Fx<I, O, Throwable> fx, Executor executor) {
...
//                futures.thenApply(list -> map(list, Pair::getLeft));
    ...
    public static <A, I, O> CompletableFuture<List<Triple<I, O, Throwable>>> watchFx(
            CompletableFuture<A> future, Collection<I> inputs, ReactiveExecutor.Fx<I, O, Throwable> fx,
            Executor executor) {
    ...
    public static <A, B, C> CompletableFuture<List<Triple<B, C, Throwable>>> watch(
            ...
            ReactiveExecutor.BiFx<A, B, C, ? extends Throwable> fx, Executor executor) {
    ...
    public static <A, B> CompletableFuture<B> wire(CompletableFuture<A> future,
                                                   ReactiveExecutor.Fx<A, B, Throwable> fx, Executor executor) {
    ...
    public static <I, O> CompletableFuture<O> futureOf(I input,
                                                       ReactiveExecutor.Fx<? super I, ? extends O, ? extends Throwable> fx, Executor executor) {
    ...
    public static <O> CompletableFuture<O> futureOf(ReactiveExecutor.Sx<O, ? extends Throwable> sx,
                                                    Executor executor) {
        CompletableFuture<O> future = new CompletableFuture<>();
        executor.execute(() -> {
            try {
    ...
    public static <O> CompletableFuture<O> catchFx(CompletableFuture<O> future,
                                                   ReactiveExecutor.Fx<Throwable, O, Throwable> fx) {
    ...
    public static <O, E extends Throwable> CompletableFuture<O> catchFx(CompletableFuture<O> future,
                                                                        Class<E> clz, ReactiveExecutor.Fx<E, O, Throwable> fx) {
    ...
    public static <V> CompletableFuture<V> timeout(CompletableFuture<V> future, int timeout,
        ...
        scheduler.schedule(() -> {
            if (!future.isCancelled() && !future.isDone()) {
                synchronized (future) {
                    if (!future.isCancelled() && !future.isDone()) {
                        future.completeExceptionally(new TimeoutException("timeout:%d", timeout));
                    }
                }
    ...
    public static <I, T> CompletableFuture<T> retry(int times, int initDelay, int intervals,
                                                    I input, ReactiveExecutor.Fx<I, T, ? extends Throwable> fx, ReactiveExecutor.Ex<I, Boolean> ex,
    ...
    public static <I, T> CompletableFuture<T> retry(int times, int intervals, I input,
                                                    ReactiveExecutor.Fx<I, T, ? extends Throwable> fx, ReactiveExecutor.Ex<I, Boolean> ex, ScheduledExecutorService es, String errorSum) {
    ...
    public static <I, T> CompletableFuture<T> retry(CompletableFuture<I> future, int times,
                                                    int intervals, ReactiveExecutor.Fx<I, T, ? extends Throwable> fx, ReactiveExecutor.Ex<I, Boolean> ex,
                                                    ScheduledExecutorService es, String errorSum) {
    ...
    public static <I, T> CompletableFuture<T> retry(CompletableFuture<I> future, int initDelay,
                                                    int times, int intervals, ReactiveExecutor.Fx<I, T, ? extends Throwable> fx, ReactiveExecutor.Ex<I, Boolean> ex,
                                                    ScheduledExecutorService es, String errorSum) {
    ...
    public static <I, T> CompletableFuture<T> delay(int delay, I input, ReactiveExecutor.Fx<I, T, Throwable> fx,
    ...
    public static <I, T> CompletableFuture<T> delay(CompletableFuture<I> future, int delay,
                                                    ReactiveExecutor.Fx<I, T, Throwable> fx, ScheduledExecutorService es) {
    ...
    public static <A, B> CompletableFuture<B> stareFx(CompletableFuture<A> futureA,
                                                      ReactiveExecutor.Fx<A, CompletableFuture<B>, Throwable> fx) {
    ...
    public static <I, O> ReactiveExecutor.Fx<I, O, Throwable> fn2fx(Function<I, O> fn) {
